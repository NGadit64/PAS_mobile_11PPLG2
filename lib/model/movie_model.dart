...
List<TablePremiereModel> tablePremiereModelFromJson(String str) => List<TablePremiereModel>.from(json.decode(str).map((x) => TablePremiereModel.fromJson(x)));

String tablePremiereModelToJson(List<TablePremiereModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
